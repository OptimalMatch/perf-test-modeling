...
import com.bank.wid.load.LoadTestRunner.WebhookPayload;
import com.bank.wid.load.TestDataGenerator.GeneratedData;
import com.bank.wid.load.TestDataGenerator.WebhookTarget;
...
public class LoadTestScenarios {
    ...
    public PerformanceReportGenerator runScenario6PodCrash() {
        ...
        // when a pod is killed mid-processing. In a real test, you'd kill wid-sor-2
        // via `docker stop wid-sor-2` during the test.
        List<WebhookPayload> webhooks = buildCrashWebhooks(2_000_000);
        LoadTestRunner runner = new LoadTestRunner(targetUrls);
        ...
        System.out.println("║    docker stop wid-sor-2                          ║");
